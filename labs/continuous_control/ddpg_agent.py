...
UPDATE_EVERY = 10       # Perform a learning pass every N steps
EPSILON_DECAY = 0.995   # Perform epsilon decay using this multiplier
...
class Agent:
    ...
    def step(self, state, action, reward, next_state, done):
        ...
        if len(self.memory) > BATCH_SIZE and self.steps % UPDATE_EVERY == 0:
